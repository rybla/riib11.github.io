...
Many people are concerned with the dangers that the new technology that society at large is ill-prepared for Overall, some main (no entirely independent) concerns I've noticed are:
- AI will soon be able to perform at many jobs more efficiently (in terms of meeting a threshold quality/cost for employers) that many humans, which will lead to mass unemployment.
