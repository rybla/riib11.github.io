...
A compilation of media I regularly consume
...
- Algebraic Lie Theory (Podcast)
- Relatively Prime: Stories from the Mathematical Domain (Podcast)
- The Numberphile Podcast
- MCMP - Mathematical Philosophy (Podcast)
- The Math Factor (Podcast)
- Breaking Math Podcast
- The Secrets of Mathematics (Podcast)
- The Type Theory Podcast
- Numberphile (YouTube)
- Mathematique et programmation (YouTube)
- Sixty Symbols (YouTube)
- 3Blue1Brown (YouTube)
- andjorhanson (YouTube)
- Bill Shillito (YouTube)
- Mathologer (YouTube)
- Henry Segerman (YouTube)
...
- Ayn Rand Institute (YouTube)
- PhilosophyInsights (YouTube)
- Center for Philosophy of Science (YouTube)
...
- Intelligence Squared U.S. Debates (Podcast)
...
- Institute for the Future (YouTube)
- Caleb Beers (YouTube)
- Plutocrat (YouTube)
- Business Casual (YouTube)
- alfsvoid (YouTube)
...
- Brackeys (YouTube)
- Adam Millard (YouTube)
- ZeoTheRogue (YouTube)
- Chariot Rider (YouTube)
- Volcanoids (YouTube)
...
- CoRecursive - Software Engineering Podcast
- Artificial Intelligence with Lex Friedman from MIT (Podcast)
- The AI Podcast
- Data Stories (Podcast)
- defn (Podcast)
- Recode Decode (Podcast)
- The Haskell Cast (Podcast)
- Corness Tech at Bloomberg Podcast
- CodeParade (YouTube)
- The Thought Emporium (YouTube)
- CGFreiburg (YouTube)
- Ben Eater (YouTube)
- Erlang Solutions (YouTube)
- Hopson (YouTube)
- Computerphile (YouTube)
- EuclideonOfficial (YouTube)
- CornellCCSL (YouTube)
- Igor Mordatch (YouTube)
- MatthewHallberg (YouTube)
- Massachusetts Institute of Technology (YouTube)
- Siraj Raval (YouTube)
- giant_neural_network (YouTube)
- Applied Science (YouTube)
- PLISS (YouTube)
- Inigo Quilez (YouTube)
- Conor McBride (YouTube)
- STARRSHIP (YouTube)
- CNLohr (YouTube)
...
- Epicenter (Podcast)
- The Bitcoin Podcast Network (Podcast)
- Blockchain - Software Engineering Daily (Podcast)
- The Third Web (Podcast)
- ConsenSysMedia (YouTube)
- RChain (YouTube)
- Compose Conference (YouTube)
- IOKH (YouTube)
- Bancor (YouTube)
- Neo Smart Economy (YouTube)
- Sweetbridge (YouTube)
- aantonop (YouTube)
- Casper Standup (YouTube)
- Ethereum Foundation (YouTube)


# Science

- Your Are Not So Smart (Podcast)
...
- The Science Salon (Podcast)
- Kurzgesagt (YouTube)
- ColdFusion (YouTube)
- PolyMatter (YouTube)
- Real Engineering (YouTube)
- The Royal Institute (YouTube)
- Wendover Productions (YouTube)
- Blair White (YouTube)
- Higgsino Physics (YouTube)
- Gad Saad (YouTube)
- Systems Academy (YouTube)
...
- Busness Casual (YouTube)

# Economics

- EconTalk (Podcast)
- Martin Shkreli (YouTube)
- Foundations for Economic Education (YouTube)
- William Spaniel (YouTube)
- Marginal Revolution University (YouTube)
...
- Dan Carlin's Hardcode History (Podcast)
...
- Grian (YouTube)
- Mumbo Jumbo (YouTube)
- ChosenArchitect (YouTube)
- ilmango (YouTube)
- AverageTunaSandwich (YouTube)
- ReikasMinecraft (YouTube)
- NuclearCraft (YouTube)
- LapisSea (YouTube)
- RagePlaysGames (YouTube)
...
- TCGplayer (YouTube)
- RTGame (YouTube)
- Channel Fireball (YouTube)
- The Spiffing Brit (YouTube)
- videogamedunkey (YouTube)
- Pyrocynical (YouTube)
- The Game Theorists
- Spice 8 Rack (YouTube)
- RedRiot (YouTube)
- StevenCrowser
- BroScienceLife (YouTube)
- Aztrosist (YouTube)
- Something Witty Entertainment (YouTube)
- MagicarpUsedFly (YouTube)
- iDubbzTV (YouTube)
- Randomise User (YouTube)
- OneyNG (YouTube)
- Taversia (YouTube)
- TomSka (YouTube)
- Sminky Animation (YouTube)
- Cartoon Hangover (YouTube)
- Steven Harmon (YouTube)
- FilmCow (YouTube)
- Cool 3D World (YouTube)
...
- davidcope (YouTube)
- slacker (YouTube)
- insaneintherainmusic (YouTube)
- Monstercat: Uncaged (YouTube)
- OMGF (YouTube)
- SOUNTEC (YouTube)
- This Week in Chiptune (YouTube)
